...
package cursodataintegration.jb_rmf_readtable_0_1;
...
/**
 * Job: JB_RMF_ReadTable Purpose: Read table from MySQL<br>
 * Description: <br>
 * 
 * @author Outlook, Rolando
 * @version 8.0.1.20250319_1318-patch
 * @status
 */
public class JB_RMF_ReadTable implements TalendJob {
	static {
		System.setProperty("TalendJob.log", "JB_RMF_ReadTable.log");
	}

	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager
			.getLogger(JB_RMF_ReadTable.class);
	...
	private final String jobName = "JB_RMF_ReadTable";
	private final String projectName = "CURSODATAINTEGRATION";
	...
	private class TalendException extends Exception {
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TalendException)) {
				JB_RMF_ReadTable.this.exception = e;
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(JB_RMF_ReadTable.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
		final static byte[] commonByteArrayLock_CURSODATAINTEGRATION_JB_RMF_ReadTable = new byte[0];
		static byte[] commonByteArray_CURSODATAINTEGRATION_JB_RMF_ReadTable = new byte[0];
		...
		public Boolean customerNumberIsNullable() {
			return true;
		}

		public Boolean customerNumberIsKey() {
			return false;
		}

		public Integer customerNumberLength() {
			return 5;
		}

		public Integer customerNumberPrecision() {
			return null;
		}
		...
		public String customerNumberComment() {

			return "";

		}

		public String customerNumberPattern() {

			return "";

		}

		public String customerNumberOriginalDbColumnName() {
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_CURSODATAINTEGRATION_JB_RMF_ReadTable.length) {
					if (length < 1024 && commonByteArray_CURSODATAINTEGRATION_JB_RMF_ReadTable.length == 0) {
						commonByteArray_CURSODATAINTEGRATION_JB_RMF_ReadTable = new byte[1024];
					} else {
						commonByteArray_CURSODATAINTEGRATION_JB_RMF_ReadTable = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_CURSODATAINTEGRATION_JB_RMF_ReadTable, 0, length);
				strReturn = new String(commonByteArray_CURSODATAINTEGRATION_JB_RMF_ReadTable, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_CURSODATAINTEGRATION_JB_RMF_ReadTable, 0, length);
				strReturn = new String(commonByteArray_CURSODATAINTEGRATION_JB_RMF_ReadTable, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_CURSODATAINTEGRATION_JB_RMF_ReadTable) {
	...
	public void tDBInput_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				util_tLogRow_1.addRow(new String[] { "customerNumber", "customerName", });
...
///////////////////////    			
				...
				if (log.isDebugEnabled()) {
					class BytesLimit65535_tDBInput_1 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDBInput_1.append(" | ");
							log4jParamters_tDBInput_1.append("HOST" + " = " + "\"172.191.83.194\"");
							log4jParamters_tDBInput_1.append(" | ");
							log4jParamters_tDBInput_1.append("PORT" + " = " + "\"3306\"");
							log4jParamters_tDBInput_1.append(" | ");
							log4jParamters_tDBInput_1.append("DBNAME" + " = " + "\"bronze\"");
							log4jParamters_tDBInput_1.append(" | ");
							log4jParamters_tDBInput_1.append("USER" + " = " + "\"talend\"");
							log4jParamters_tDBInput_1.append(" | ");
							log4jParamters_tDBInput_1.append("PASS" + " = " + String.valueOf(
									"enc:routine.encryption.key.v1:BvYylV+hdOsRSOoeSE8TtaNr4Q1PQ5VB8IHJB2bdIyktCQ==")
									.substring(0, 4) + "...");
							log4jParamters_tDBInput_1.append(" | ");
							...
							log4jParamters_tDBInput_1.append("TRIM_COLUMN" + " = " + "[{TRIM=" + ("false")
									+ ", SCHEMA_COLUMN=" + ("customerNumber") + "}, {TRIM=" + ("false")
									+ ", SCHEMA_COLUMN=" + ("customerName") + "}]");
							log4jParamters_tDBInput_1.append(" | ");
				...
				final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:z6edZGgN8gXfOG0JfDLo4dAe6gxL+IO8QlkePattmUu8QQ==");
				...
				String url_tDBInput_1 = "jdbc:mysql://" + "172.191.83.194" + ":" + "3306" + "/" + "bronze" + "?"
						+ properties_tDBInput_1;
				...
				try {
					...
					while (rs_tDBInput_1.next()) {
						...
						if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
								...
								, "row1", "tDBInput_1", "tDBInput_1", "tMysqlInput", "tLogRow_1", "tLogRow_1", "tLogRow"
...
///////////////////////    			
				...
				if (runStat.updateStatAndLog(execStat, enableLogStash, resourceMap, iterateId, "row1", 2, 0,
						"tDBInput_1", "tDBInput_1", "tMysqlInput", "tLogRow_1", "tLogRow_1", "tLogRow", "output")) {
					talendJobLogProcess(globalMap);
				}
	...
	public static void main(String[] args) {
		final JB_RMF_ReadTable JB_RMF_ReadTableClass = new JB_RMF_ReadTable();

		int exitCode = JB_RMF_ReadTableClass.runJobInTOS(args);
		if (exitCode == 0) {
			log.info("TalendJob: 'JB_RMF_ReadTable' - Done.");
		}
	...
	public int runJobInTOS(String[] args) {
		...
		getjobInfo();
		log.info("TalendJob: 'JB_RMF_ReadTable' - Start.");
		...
		org.slf4j.MDC.put("_jobRepositoryId", "_TRm6wB6uEfC2Lp0ZKifwBQ");
		org.slf4j.MDC.put("_compiledAtTimestamp", "2025-04-21T14:16:09.089300Z");
		...
		try {
			...
			java.io.InputStream inContext = JB_RMF_ReadTable.class.getClassLoader().getResourceAsStream(
					"cursodataintegration/jb_rmf_readtable_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = JB_RMF_ReadTable.class.getClassLoader()
		...
		log.info("TalendJob: 'JB_RMF_ReadTable' - Started.");
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : JB_RMF_ReadTable");
		}
		if (enableLogStash) {
		...
		log.info("TalendJob: 'JB_RMF_ReadTable' - Finished - status: " + status + " returnCode: " + returnCode);
...
/************************************************************************************************
 * 73319 characters generated by Talend Cloud Data Fabric on the 21 April 2025
 * at 10:16:09 CLT
 ************************************************************************************************/